...
def accept_invitation(request, id):
    ...
    if request.method == 'POST':
        ...
        invitation.delete()
        return redirect(game)# django will automatically use get_absolute_url function in class game of gameplay/models.py
    else:
...
class SignUpView(CreateView):
    ...
    # writing too much model code in view is not a good practise.
    # So we dont use the below code instead write similar in models.py
