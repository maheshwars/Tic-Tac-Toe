...
class Game(models.Model):
    ...
    #this returns manager object which includes functions from /
    # GamesQuerySet and we assign that manager to object attribute of game class.
    ...
    def get_absolute_url(self): # gets url for game object
        return reverse('gameplay_detail', args=[self.id]) #reverse constructs url for mapping with this name

    def __str__(self):
        return "{0} vs {1}".format(self.first_player,
                                self.second_player)
